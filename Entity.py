...
# class Enemy:
#     def __init__(self, name, health, armor, strength, dexterity, enemyWeapon):
#         self.name = name
#         self.health = health
#         self.armor = armor
...
# Goblin = Enemy("Goblin", 15, 10, 8, 12, random.choice(d6Weapon))
# Skeleton = Enemy("Skeleton", 13, 13, 10, 11, random.choice(d8Weapon)) 
# Slime = Enemy("Slime", 10, 8, 10, 15, None) #Slimes should be easy to hit but fast
